for(iter in 1..1050) {
  ...
  switch(topic) {
    ...
    {|v| "38".contains(v) }: Fiber.abort("matched 38")
    {|v| "39".contains(v) }: Fiber.abort("matched 39")
    {|v| "40".contains(v) }: Fiber.abort("matched 40")
    {|v| "41".contains(v) }: Fiber.abort("matched 41")
    {|v| "42".contains(v) }: Fiber.abort("matched 42")
    {|v| "43".contains(v) }: Fiber.abort("matched 43")
    {|v| "44".contains(v) }: Fiber.abort("matched 44")
    {|v| "45".contains(v) }: Fiber.abort("matched 45")
    {|v| "46".contains(v) }: Fiber.abort("matched 46")
    {|v| "47".contains(v) }: Fiber.abort("matched 47")
    {|v| "48".contains(v) }: Fiber.abort("matched 48")
    {|v| "49".contains(v) }: Fiber.abort("matched 49")
    {|v| "50".contains(v) }: Fiber.abort("matched 50")
  } //switch
} //iter
